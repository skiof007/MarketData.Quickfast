...
#include <vector>
#include <quickfast/Codecs/SegmentBody_fwd.h>
...
namespace QuickFAST{
  namespace Codecs{
    ...
    public:
	  ...
	  const InstructionVector::const_iterator begin() const
	  {
		  return instructions_.cbegin();
	  }
	  const InstructionVector::const_iterator end() const
	  {
		  return instructions_.cend();
	  }
	  
	  MutableInstructionVector::iterator begin()
	  {
		  return mutableInstructions_.begin();
	  }
	  MutableInstructionVector::iterator end()
	  {
		  return mutableInstructions_.end();
	  }

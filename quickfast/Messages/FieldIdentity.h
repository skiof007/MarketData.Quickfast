...
#include <string>
#include <quickfast/Messages/FieldIdentity_fwd.h>
...
namespace QuickFAST{
  namespace Messages{
    ...
    public:
	  ...
	  typedef decltype(dummy) CallbackFunctionType;
    ...
    public:
	  ...
	  const unsigned __int32 GetIntID() const { return int_id_; }
      ...
      bool operator == (const FieldIdentity & rhs) const
      {
        return(
		  ...
		  (int_id_ == 0 || rhs.int_id_ == 0 || int_id_ == rhs.int_id_));
      }
	  ...
	  CallbackFunctionType * GetObjectCallback() const { return objectCallback; }
	  void SetObjectCallback(CallbackFunctionType * func) { objectCallback = func; }
    ...
    private:
	  unsigned __int32 int_id_;
      std::string localName_;
      std::string fieldNamespace_;
      std::string fullName_; // cached for performance
      field_id_t id_;
	  CallbackFunctionType * objectCallback;
	  static CallbackFunctionType * defaultObjectCallback;
    private:

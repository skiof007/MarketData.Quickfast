...
#include <quickfast/Messages/MessageField_fwd.h>
#include <quickfast/Messages/FieldIdentity_fwd.h>
#include <quickfast/Messages/Field.h>
...
namespace QuickFAST
{
  namespace Messages
  {
    ...
    public:
      ...
      /// @param type is the type of data requested
      /// @param value is the value to be returned.
      virtual bool getString(const FieldIdentity & identity, ValueType::Type type, StringBuffer & value)const = 0;

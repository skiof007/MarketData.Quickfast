...
#include <quickfast/Messages/MessageField.h>
...
namespace QuickFAST
{
  namespace Messages
  {
    ...
    class EmptyAccessor : public Messages::MessageAccessor
    {
      ...
      virtual bool getString(const FieldIdentity & identity, ValueType::Type type, StringBuffer & value)const;
    ...
    inline bool
    EmptyAccessor::getString(const FieldIdentity & identity, ValueType::Type type, StringBuffer & value)const
    {
      return false;
    }
    ...
    inline bool
    SingleFieldAccessor::getString(const FieldIdentity & identity, ValueType::Type type, StringBuffer & value)const
    {
